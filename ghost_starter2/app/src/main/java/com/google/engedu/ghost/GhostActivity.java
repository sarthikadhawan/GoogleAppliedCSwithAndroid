...
public class GhostActivity extends AppCompatActivity {
    ...
    public boolean onStart(View view) {
        ...
        int ans = random.nextInt(fdictionary.words.size());
        String y=fdictionary.words.get(ans);
        //text.setText(y);
        while(y.length() < 4 && fdictionary.isWord(y))
        {
             ans = random.nextInt(fdictionary.words.size());
             y=fdictionary.words.get(ans);
        }
    ...
    private void computerTurn()
    {
        ...
        if(ch==0)
        {
            ...
            String w = fdictionary.getAnyWordStartingWith(prefix);
            //text.setText(w);
            if (w != null)
            {
    ...
    public int check()
    {
        ...
        String w=fdictionary.getAnyWordStartingWith(prefix);
        //text.setText(w);
        if(fdictionary.isWord(prefix.toString())&&prefix.length()>=4)
...
return 0;
    ...
    public void challenge(View view)
    {
        ...
        {
            String str=fdictionary.getAnyWordStartingWith(prefix);
            if(str!=null)
            {
                text.setText(str);
